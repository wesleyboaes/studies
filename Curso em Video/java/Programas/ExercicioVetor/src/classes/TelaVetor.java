...
public class TelaVetor extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        getValue pega o valor e toString converte para txt, o getValue não é
        tratado como int, por isso precisa dessa converção td*/
        lista.removeAllElements();//limpar a lista
        for (int c=0;c<vetor.length;c++){//for para mostrar lista atualizada
            lista.addElement(vetor[c]);
        }
