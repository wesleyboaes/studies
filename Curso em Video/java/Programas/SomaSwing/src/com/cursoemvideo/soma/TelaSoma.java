...
public class TelaSoma extends javax.swing.JFrame {
    ...
    private void btnSomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSomaActionPerformed
        // TODO add your handling code here:
        // n1 e n2 são inteiros, logo não adianta atribuir o getText sem converter para inteiro, pois vai dar erro de incompatibilidade
        int n1 = Integer.parseInt(txtN1.getText());
        int n2 = Integer.parseInt(txtN2.getText());
        int s = n1+n2;
        //o msm ocorre ao tentar atribuir s que eh inteiro ao lblSoma.setText que mostra string, necessita converter o s de inteiro para texto
